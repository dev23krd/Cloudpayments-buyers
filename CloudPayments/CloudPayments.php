...
class CloudPayments extends Buyers {
    ...
    public function checkout_form($order_id, $button_text = null) {
        ...
        $amount         = floatval($this->money->convert($total, $payment_method->currency_id, false));
        ...
        $button .= "<input type='submit' class='btn btn--default btn--sm has-ripple' value='" . $button_text . "'>";
        $button .= "</form>" . PHP_EOL;
        $button .= <<<SCRIPT
        <script>
